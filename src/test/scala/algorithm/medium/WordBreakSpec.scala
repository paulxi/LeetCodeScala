...
import com.leetcode.algorithm.medium.WordBreak.Solution._
import org.scalatest._

class WordBreakSpec extends FlatSpec with Matchers {
  "'leetcode'" should "return true" in {
    wordBreak("leetcode", List("leet", "code")) shouldEqual true
  }

  "'applepenapple'" should "return true" in {
    wordBreak("applepenapple", List("apple", "pen")) shouldEqual true
  }

  "'catsandog'" should "return false" in {
    wordBreak("catsandog", List("cats", "dog", "sand", "and", "cat")) shouldEqual false
  }

  "'fohhemkkaecojceoaejkkoedkofhmohkcjmkggcmnami'" should "return true" in {
    wordBreak("fohhemkkaecojceoaejkkoedkofhmohkcjmkggcmnami", List("kfomka", "hecagbngambii",
    ...
    "iohchafbega", "kjejfhbco", "anlhhhhg")) shouldEqual true
  }
}
